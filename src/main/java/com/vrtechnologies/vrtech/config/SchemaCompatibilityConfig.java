...
public class SchemaCompatibilityConfig {
    ...
    CommandLineRunner normalizeLegacyEnumColumns(JdbcTemplate jdbcTemplate) {
        return args -> {
            ...
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN logo_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN favicon_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN shipping_note TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN company_address TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN invoice_terms TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN return_policy TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN map_link TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN state_delivery_charges TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN state_delivery_windows TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN default_home_section_types TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN footer_description TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN facebook_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN instagram_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN x_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN linkedin_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN youtube_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings MODIFY COLUMN security_notice TEXT NULL");
            ...
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN state_delivery_charges TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN state_delivery_windows TEXT NULL");
            ...
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN logo_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN favicon_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN tagline TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN footer_description TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN facebook_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN instagram_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN x_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN linkedin_url TEXT NULL");
            migrate(jdbcTemplate, "ALTER TABLE site_settings ADD COLUMN youtube_url TEXT NULL");
            ...
            // Custom delivery check tables
            migrate(jdbcTemplate, "CREATE TABLE IF NOT EXISTS pincode_zones (id BIGINT NOT NULL AUTO_INCREMENT, match_type VARCHAR(32) NOT NULL, match_value VARCHAR(120) NOT NULL, zone_name VARCHAR(80) NOT NULL, serviceable BIT NOT NULL DEFAULT 1, cod_available BIT NOT NULL DEFAULT 1, prepaid_available BIT NOT NULL DEFAULT 1, delivery_charge DECIMAL(10,2) NOT NULL DEFAULT 0, free_delivery_threshold DECIMAL(10,2) NULL, min_delivery_days INT NOT NULL DEFAULT 1, max_delivery_days INT NOT NULL DEFAULT 5, priority INT NOT NULL DEFAULT 100, active BIT NOT NULL DEFAULT 1, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id))");
            migrate(jdbcTemplate, "CREATE TABLE IF NOT EXISTS pincode_blacklist (id BIGINT NOT NULL AUTO_INCREMENT, pincode VARCHAR(6) NOT NULL UNIQUE, reason VARCHAR(255) NULL, active BIT NOT NULL DEFAULT 1, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id))");
